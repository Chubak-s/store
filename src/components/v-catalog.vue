...
export default {
  ...
  data() {
    return {
      catalog: [
        {name: 'Phillip Plein black', img: "/bracelets/phillip-plein.png", price: 34800, category: 'bracelets', information: 'Состав Гипоаллергенная нержавеющая сталь - 100%; Сезон мульти; Цвет черный; Застежка на замке; Страна производства Китай'},
